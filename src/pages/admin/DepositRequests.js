...
import { CheckCircleIcon, EyeIcon, XCircleIcon, BellIcon, CurrencyDollarIcon } from '@heroicons/react/24/outline';
...
export default function DepositRequests() {
  ...
  const handleRejectDeposit = async (requestId) => {
    ...
    try {
      ...
      if (response.ok) {
        setToastMessage('Deposit rejected');
        setShowToast(true);
        fetchDepositRequests();
      } else {
      ...
      setToastMessage('Failed to reject deposit');
      setShowToast(true);
    } finally {
      setProcessingId(null);
    }
    ...
    <div className="min-h-screen bg-gray-100">
      ...
      <div className="bg-white border-b border-gray-200 px-6 py-4">
        <div className="flex items-center justify-between">
          <h1 className="text-2xl font-semibold text-gray-900">Deposit Requests</h1>
      ...
      <div className="p-6">
        <p className="text-gray-600 text-sm mb-6">Review and approve wallet deposit requests from users.</p>
        ...
        <div className="bg-white rounded-lg shadow-sm">
                ...
                {depositRequests.map((request) => (
                  <tr key={request.id} className="hover:bg-gray-50">
                    ...
                    <td className="px-6 py-4 whitespace-nowrap">
                      ...
                      <div className="text-xs text-gray-500">Wallet Deposit</div>
                    </td>
          ...
          {depositRequests.length === 0 && (
            <div className="text-center py-12">
              ...
              <p className="text-gray-500">All deposit requests have been processed.</p>
            </div>
          )}
        </div>
      </div>
